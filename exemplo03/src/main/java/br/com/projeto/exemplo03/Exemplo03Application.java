...
import br.com.projeto.exemplo03.repositorio.AlunosRepository;
import br.com.projeto.exemplo03.repositorio.CursoRepository;
...
public class Exemplo03Application {
	...
	@Bean
public CommandLineRunner mappingDemo(AlunosRepository ar, CursoRepository cr) {
    return args -> {
